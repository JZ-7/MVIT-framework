...
system = 'nn5_daily_dataset_without_missing_values'
data_train = np.loadtxt('C:/Users/JXM/PycharmProjects/RC_ESN/MVIT_upload/DATA_TRAIN/'+system+'_train.txt')
data_target = np.loadtxt('C:/Users/JXM/PycharmProjects/RC_ESN/MVIT_upload/DATA_TARGET/'+system+'_target.txt')

pre_steps = 10
target_dim = [86, 48, 46, 5]
Standard = 'standard'
dimforpre_num = 11
